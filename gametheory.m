...
A = Avery(901:s,1:t);
%The following converts Avery's testing table to testing matrix.
A = A{:,:};
...
[xx zz_avery] = linprog(-c, Aineq, bineq, Aeq, beq, lb);
...
%Be sure to negate the result since we are solving max zz_avery, which is the same as -min-zz_avery.
-zz_avery    
